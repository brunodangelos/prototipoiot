import { ParserPlugin as babel_ParserPlugin } from '@babel/parser';
/**
 * @internal
 */
export declare type ValueFactoryApi = {
    preventCache(): void;
};
/**
 * @internal
 */
export declare type ValueFactory = (api: ValueFactoryApi) => Promise<any>;
export declare type Cache = {
    get(key: string): Promise<string>;
    set(key: string, value: string): Promise<void>;
};
export declare type ModuleCacheId = string;
/**
 ...
 */
export declare type AbstractPath = {
    toString(): string;
};
/**
...
export declare type PathResolve = (pathCx: PathContext) => AbstractPath;
/**
 ...
 * ```
 */
export declare type ModuleHandler = (type: string, getContentData: File['getContentData'], path: AbstractPath, options: Options) => Promise<ModuleExport | null>;
export declare type ContentData = string | ArrayBuffer;
/**
 ...
 */
export declare type CustomBlockCallback = (component: ModuleExport) => void;
/**
 * A custom block
 */
 ...
 * @internal
 */
export declare type LoadingType<T> = {
    promise: Promise<T>;
};
...
export declare type LangProcessor = (source: string, preprocessOptions?: any) => Promise<string> | string;
