...
<script type="module">
  console.log("fd-custom module is executing")
...
`.trimStart().replace(/^\[/gm,"<")
  ...
  RED.nodes.registerType("flexdash custom", {
    ...
    oneditprepare() {
      try{
        console.log("fd-custom oneditprepare ???")
        ...
        tabs.addTab({ id: "fd-tab-vue", label: "Vue" })
        ...
        // // Vue tab content
        // this.vue_app = window.fd_mount(this, $('#fd-vue-app')[0])
        // tabs.activateTab("fd-tab-vue")
        // console.log("Mounted and activated Vue tab", $('#fd-tab-vue'))
      } catch(e) { console.log("fd-custom oneditprepare:", e, e.stack) }
    },

    oneditsave() { // save the typedInput props so we get the types right
      try {
        console.log("fd-custom oneditsave")
        ...
        this.vue_app?.save()
      } catch(e) { console.log("fd-custom oneditsave:", e, e.stack) }
    },
...
<!-- script type="text/html" data-template-name="flexdash custom">
  ...
  <div id="fd-tabs-content"
    ...
    <!-- div id="fd-tab-general" style="display:none"></div>
    ...
    <!-- Vue tab -->
    <!-- div id="fd-tab-vue" style="display:none">
      <div id="fd-vue-app">Loading...</div>
    </div>
  </div>
</script -->
